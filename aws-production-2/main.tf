...
variable "worker_ami" { default = "ami-ac795abb" }
...
module "aws_asg_com" {
  ...
  worker_docker_image_android = "travisci/ci-amethyst:packer-1478733269"
  worker_docker_image_default = "travisci/ci-garnet:packer-1478733230"
  worker_docker_image_erlang = "travisci/ci-amethyst:packer-1478733269"
  worker_docker_image_go = "travisci/ci-garnet:packer-1478733230"
  worker_docker_image_haskell = "travisci/ci-amethyst:packer-1478733269"
  worker_docker_image_jvm = "travisci/ci-garnet:packer-1478733230"
  worker_docker_image_node_js = "travisci/ci-garnet:packer-1478733230"
  worker_docker_image_perl = "travisci/ci-amethyst:packer-1478733269"
  worker_docker_image_php = "travisci/ci-garnet:packer-1478733230"
  worker_docker_image_python = "travisci/ci-garnet:packer-1478733230"
  worker_docker_image_ruby = "travisci/ci-garnet:packer-1478733230"
