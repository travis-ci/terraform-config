...
module "jupiter_brain_production_org" {
  ...
  app_version    = "${var.jupiter_brain_production_version}"
...
module "jupiter_brain_staging_org" {
  ...
  ssh_ip_address = "${module.macstadium_infrastructure.wjb_ip}"
  ssh_user       = "${var.ssh_user}"
  app_version    = "${var.jupiter_brain_staging_version}"
...
module "jupiter_brain_custom_1" {
  ...
  ssh_ip_address = "${module.macstadium_infrastructure.wjb_ip}"
  ssh_user       = "${var.ssh_user}"
  app_version    = "${var.jupiter_brain_custom-1_version}"
...
module "jupiter_brain_custom_2" {
  ...
  ssh_ip_address = "${module.macstadium_infrastructure.wjb_ip}"
  ssh_user       = "${var.ssh_user}"
  app_version    = "${var.jupiter_brain_custom-2_version}"
...
module "jupiter_brain_custom_4" {
  ...
  ssh_ip_address = "${module.macstadium_infrastructure.wjb_ip}"
  ssh_user       = "${var.ssh_user}"
  app_version    = "${var.jupiter_brain_custom-4_version}"
...
module "jupiter_brain_custom_5" {
  ...
  ssh_ip_address = "${module.macstadium_infrastructure.wjb_ip}"
  ssh_user       = "${var.ssh_user}"
  app_version    = "${var.jupiter_brain_custom-5_version}"
...
module "jupiter_brain_custom_6" {
  ...
  ssh_ip_address = "${module.macstadium_infrastructure.wjb_ip}"
  ssh_user       = "${var.ssh_user}"
  app_version    = "${var.jupiter_brain_custom-6_version}"
