...
variable "jupiter_brain_custom-1_version" { default = "v1.0.0" }
variable "jupiter_brain_custom-2_version" { default = "v1.0.0" }
variable "jupiter_brain_custom-3_version" { default = "v1.0.0" }
